...
import hr.fer.oop.lab3.implementation.FootballPlayer;
import hr.fer.oop.lab3.implementation.NationalTeam;
...
public class NationalTeamTest {
	...
	public static void main(String[] args) {
		...
		if (!defaultTeam.isPlayerRegistered(player)) {
			System.err.println("TEST FAILED: Default national team country and default player country not match!!");
		}
