...
public interface Manager {
	 ...
	 * Players are picked in the order of their position in the array
	 * tempPlayers, and they are formed in the tempFormation.
	 * If there are not enough players to fill the startingEleven, this
	 * method clears the startingEleven.
	 * 
	 */
